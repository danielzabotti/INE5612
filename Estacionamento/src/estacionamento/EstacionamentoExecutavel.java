 ...
 * @author daniel
 */
public class EstacionamentoExecutavel {
        /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ControladorEstacionamento controlador = new ControladorEstacionamento();
                FrameBaseEstacionamento visao = new FrameBaseEstacionamento(controlador);
                controlador.registrarView(visao);
